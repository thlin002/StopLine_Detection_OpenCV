...
while flag:
	...
	color = 255
	cv2.fillPoly(mask, vertices, color, cv2.THRESH_BINARY)
	...
	ret,thresIm = cv2.threshold(smoothedIm, int(mean[0]+1*stddev[0]), 0, cv2.THRESH_TOZERO)
