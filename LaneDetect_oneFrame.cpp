...
*/
	 ...
	 cv::Point p1 = cv::Point(image.size().width * 1.0/18.0, image.size().height);
	 cv::Point p2 = cv::Point(image.size().width * (0.5 - 1.0/8.0), image.size().height * 8.0/15.0);
	 cv::Point p3 = cv::Point(image.size().width * (0.5 + 1.0/8.0), image.size().height * 8.0/15.0);
	 cv::Point p4 = cv::Point(image.size().width * 19.0/18.0, image.size().height);
